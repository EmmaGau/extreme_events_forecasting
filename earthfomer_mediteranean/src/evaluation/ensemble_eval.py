...
class EnsembleEvaluation:
    def __init__(self, pred_files, ground_truth_file, climatology_file, climatology_std_file, entire_era_file, var, save_dir):
        ...
        self.var = var
        file_name = pred_files[0].split('/')[-1]
...
if __name__ == '__main__':
    ...
    climatology_file = "/home/egauillard/extreme_events_forecasting/earthfomer_mediteranean/src/model/experiments/earthformer_era_20240822_125058_every_coarse_17/inference_plots/model-skill-epoch=025-valid_skill_score=0.02.ckpt/all_climatology.nc"
    climatology_std_file = "/home/egauillard/extreme_events_forecasting/earthfomer_mediteranean/src/model/experiments/earthformer_era_20240822_125058_every_coarse_17/inference_plots/model-skill-epoch=025-valid_skill_score=0.02.ckpt/all_climatology_std.nc"
    ground_truth_file = "/home/egauillard/extreme_events_forecasting/earthfomer_mediteranean/src/model/experiments/earthformer_era_20240822_125058_every_coarse_17/inference_plots/model-skill-epoch=025-valid_skill_score=0.02.ckpt/all_ground_truths.nc"
    entire_era_file = "/home/egauillard/extreme_events_forecasting/earthfomer_mediteranean/src/model/experiments/earthformer_era_20240911_141950_every_coarse_lead_tim14/1940_2024_target.nc"
